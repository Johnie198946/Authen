...
import { Card, Table, Tag, Button, Space, Modal, Form, Input, InputNumber, message, Popconfirm } from 'antd';
...
export default function SubscriptionsPanel() {
  ...
  const openEdit = (plan: any) => {
    setEditingPlan(plan);
    form.setFieldsValue({ name: plan.name, description: plan.description, duration_days: plan.duration_days, price: plan.price });
    setEditModal(true);
  };
